  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox again, where freelancers meet opportunities. A marketplace designed to connect talent with companies offering jobs."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox again, where freelancers meet opportunities. A marketplace designed to connect talent with companies offering jobs.`}
            </Text>
            <Box
