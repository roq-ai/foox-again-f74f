...
export function JobListPage(props: JobListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getJobs({
        relations: ['company', 'country', 'application.count', 'hiring.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['job_requirements.contains', 'job_location.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'job_duration', header: 'job_duration', accessorKey: 'job_duration' },
    { id: 'job_requirements', header: 'Job Requirements', accessorKey: 'job_requirements' },
    { id: 'job_location', header: 'Job Location', accessorKey: 'job_location' },
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('country', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'country',
          header: 'Country',
          accessorKey: 'country',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/countries/view/${record.country?.id}`}>
              {record.country?.name}
            </Link>
          ),
        }
