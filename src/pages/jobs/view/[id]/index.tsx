          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Job Duration" text={data?.job_duration} />

                <FormListItem label="Job Requirements" text={data?.job_requirements} />

                <FormListItem label="Job Location" text={data?.job_location} />
                ...
                {hasAccess('country', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Country"
                    text={
                      <Link as={NextLink} href={`/countries/view/${data?.country?.id}`}>
                        {data?.country?.name}
                      </Link>
                    }
                  />
